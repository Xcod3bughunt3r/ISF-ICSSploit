...
from icssploit.utils import iter_modules
from icssploit.test import icssploitTestCase


class ModuleTest(icssploitTestCase):
    """A unit_test case that every module must pass.
...
def load_tests(loader, tests, pattern):
    """ Map every module to a unit_test case, and group them into a suite. """
